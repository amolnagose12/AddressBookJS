...
try {
    addressBookArray.push(new Contact("Sachin", "Johnson", "balajiNagar", "Nagpur", "Maharastra", 440016, "91 1234567890", "sachin@gmail.com"));
} catch (e) {
    console.error(e);
}

try {
    addressBookArray.push(new Contact("Amol", "Nagose","NarendraNagar", "Ngpur", 'Maharatra', 555588, '91 7894561230', "abc@gmail.com"));
} catch (e) {
    console.log(e);
}
